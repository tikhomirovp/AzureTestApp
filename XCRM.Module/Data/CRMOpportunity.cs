...
namespace XCRM.Module.Data {
    ...
    public class CRMOpportunity : Opportunity, IQuoteOpportunity, IOrderOpportunity, ILeadTarget, IGenericAddressableSale, ISaleStageHistoryTarget, IXafEntityObject, IObjectSpaceLink {
